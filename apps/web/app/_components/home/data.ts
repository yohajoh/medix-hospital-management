...
export const ecosystemCards: TagCard[] = [
  ...
  },
  {
    ...
    description:
      "Predictive inventory management and e-prescribing modules prevent unsafe interactions in all audits.",
    icon: "\uD83D\uDC8A",
...
export const centerCards: TagCard[] = [
  {
    title: "Oncology",
    description:
      "Oncology is a trauma-informed clinical pathway with precision care.",
    image:
  ...
  },
  {
    title: "Cardiology",
    description:
      "Advanced diagnostics and coordinated interventions for every cardiac profile.",
    image:
  ...
  },
  {
    title: "Neurology",
    description:
      "Data-rich clinical decision support for brain and nerve disorders.",
    image:
  ...
  },
  {
    title: "Orthopedics",
    description:
      "Sports medicine, arthroscopy, and rehabilitation with digital post-op plans.",
    image:
      "https://images.unsplash.com/photo-1580281658629-8ff6f47c9f7f?auto=format&fit=crop&w=900&q=80",
    cta: "Learn More",
  },
];
...
export const specialistCards: PersonCard[] = [
  {
    ...
    role: "Speciality",
    description:
      "Professional with broad operational and interventional expertise.",
    image:
  ...
  },
  {
    ...
    role: "Speciality",
    description:
      "Professional with current evidence-focused bedside and outpatient practice.",
    image:
  ...
  },
  {
    ...
    role: "Necrology",
    description:
      "Clinic notes as a brief interdisciplinary coordination layer for every case.",
    image:
  ...
  },
  {
    ...
    role: "Orthopedics",
    description:
      "Evidence-driven diagnostics and minimally invasive treatment pathways.",
    image:
...
export const testimonials: Testimonial[] = [
  {
    quote:
      "I never felt alone. The care team shared updates quickly and helped my family understand every decision.",
    name: "Nama Bilmars",
    role: "Patient",
    avatar:
  ...
  {
    quote:
      "I saw true coordination between nurses and doctors. The process felt safe, clear, and consistent.",
    name: "Jansh Roltan",
    role: "Patient",
    avatar:
      "https://images.unsplash.com/photo-1519244703995-f4e0f30006d5?auto=format&fit=crop&w=200&q=80",
  },
];
