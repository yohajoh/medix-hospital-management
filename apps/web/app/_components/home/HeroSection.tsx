    ...
    <section className="mx-auto mt-3 w-full max-w-7xl px-4 sm:px-6 lg:px-8">
      <div className="relative overflow-hidden rounded-xl">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center px-6 text-center">
          ...
          <p className="mt-5 max-w-2xl text-lg font-medium text-[var(--ca-hero-subtext)] md:text-2xl">
            A high-performance framework engineered for precision medicine and operational excellence.
          </p>
          <button
            type="button"
            className="mt-8 inline-flex h-14 items-center rounded-xl border border-[#6f8db2] bg-[var(--ca-brand-900)] px-8 text-lg font-semibold text-white shadow-[0_12px_26px_rgba(16,42,74,0.38)]"
          >
